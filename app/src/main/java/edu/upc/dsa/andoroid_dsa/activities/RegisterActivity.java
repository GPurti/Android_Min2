...
public class RegisterActivity extends AppCompatActivity {
    ...
    public void doRegister(View view){
        ...
        UserInformation user = new UserInformation(nameTxt.getText().toString(), surnameTxt.getText().toString(), birthdayTxt.getText().toString(), emailTxt.getText().toString(), passwordRegisterTxt.getText().toString(),50,"avatar");
