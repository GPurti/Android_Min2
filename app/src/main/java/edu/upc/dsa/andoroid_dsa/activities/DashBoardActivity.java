...
public class DashBoardActivity extends AppCompatActivity implements View.OnClickListener {
    public CardView yourProfile, gadgetShop, logOut, rankingView;
    ...
    public void onClick(View view) {
        ...
        switch(view.getId()){
            ...
            case R.id.returnBtn:
                ...
                startActivity(i);
                break;
            case R.id.puntuations:
                i=new Intent(this, UsersRanking.class);
                startActivity(i);
                break;
            case R.id.chatCard:
    ...
    public void getCardViewsReady(){
        ...
        rankingView=(CardView) findViewById(R.id.puntuations);
